...
| Item | Value |
|------|-------|
| Endpoint | `POST https://app-curqq4wh9wxt-api-rLobRWZ712b9.gateway.appmedo.com/v1beta/models/gemini-3.1-flash-image-preview:generateContent` |
...
// POST to: https://app-curqq4wh9wxt-api-rLobRWZ712b9.gateway.appmedo.com/v1beta/models/gemini-3.1-flash-image-preview:generateContent
