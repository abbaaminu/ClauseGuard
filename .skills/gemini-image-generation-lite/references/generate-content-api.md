...
|------|-------|
| Method | `POST` |
| Endpoint | `https://app-curqq4wh9wxt-api-rLobRWZ712b9.gateway.appmedo.com/v1beta/models/gemini-3.1-flash-image-preview:generateContent` |
...
async function generateOrEditImage(
  ...
  const response = await fetch(
    "https://app-curqq4wh9wxt-api-rLobRWZ712b9.gateway.appmedo.com/v1beta/models/gemini-3.1-flash-image-preview:generateContent",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
